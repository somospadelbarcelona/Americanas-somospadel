...
(function () {
    const CONFIG = {
        ...
        disableRightClick: false,       // Bloquear clic derecho
        disableCopyPaste: false,        // Bloquear copiar/pegar
        disableKeys: false,             // Bloquear F12, Ctrl+U, etc.
        debuggerTrap: false             // Activar trampa de debugger infinito
    };
